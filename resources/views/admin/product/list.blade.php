                ...
                <form action="{{ route('product.index') }}" method="GET">
                    <div class="input-group">
                        ...
                        <div class="input-group-append">
                            <button id="button-addon1" type="submit" class="btn btn-link text-primary"><i class="lni lni-search-alt"></i></button>
                        </div>
                    </div>
                </form>
            </div>
            <a class="btn btn-primary m-3" href="{{ route('product.create') }}">
                <i class="lni lni-circle-plus"></i> Add Product</a>
        </div>
        <table class="table" style="background-color: #2E2E48;">
            <thead>
                <tr>
                    <th scope="col">ID</th>
